        ...
        <DropdownMenu.Root>
          <DropdownMenu.Trigger>
            <div className="grid grid-cols-[auto_1fr] gap-2 p-2 rounded-xl cursor-pointer hover:bg-[#222222] w-fit px-2 text-right">
              <div className="flex flex-col items-end w-full justify-center gap-0.5">
                <span className="text-white/70 font-medium text-sm mr-1">
          ...
          <DropdownMenu.Portal>
            <DropdownMenu.Content
              side="bottom"
              className="bg-black rounded-xl text-center cursor-pointer space-y-1 p-1 w-full"
              sideOffset={10}
            >
              <button
                onClick={logout}
                className="bg-primary rounded-lg p-2 px-3 text-center cursor-pointer font-druk leading-none text-sm text-white hover:bg-white/10"
              >
                Signout
              </button>
            </DropdownMenu.Content>
