...
export function Liveline({
  ...
  return (
    <>
      ...
      >
        <canvas ref={canvasRef} style={{ display: 'block', cursor: draw?.enabled ? 'crosshair' : cursorStyle }} />

        {/* Drawing stroke panel */}
        {draw?.enabled && (
          <div className={cn('absolute z-20 flex flex-col gap-1.5 rounded-lg p-2 right-2 top-2')}>
